...
export const ProfileQuiz = () => {
  ...
  // 1. Стан для відповідей (ініціалізація з localStorage)
  ...
  // 2. Збереження проміжного прогресу
  useEffect(() => {
  ...
  const calculateResult = (finalAnswers: string[]) => {
    ...
    finalAnswers.forEach((answer, index) => {
      ...
      // Логіка балів (після 12-го питання бали подвоюються)
  ...
  const handleFinishQuiz = () => {
    ...
    // Зберігаємо ключ, який очікує твій компонент Profile
    localStorage.setItem('quiz_result_key', winnerKey);

    // Очищаємо тимчасовий прогрес
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full gap-10 p-6 lg:p-20 bg-white min-h-screen">
      <div className="flex-1">
        ...
        <div className="flex items-center justify-end w-full mt-10 pt-6 border-t border-gray-100">
          <button
            type="button"
