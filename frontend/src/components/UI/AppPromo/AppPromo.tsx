        ...
        <ul className="space-y-4 mb-10">
          {[
            ...
            <li key={index} className="flex items-start gap-3">
              <div className="mt-1 bg-success rounded-full p-1 shrink-0">
                <svg
        ...
        <div className="flex flex-col lg:flex-row gap-4 w-fit">
          ...
          bg-primary-dark-90 border-2 text-white
           border-indigo-100  pl-9 pr-2 py-4 lg:w-[50%]
            lg:h-16 rounded-2xl hover:bg-primary-dark-80 transition-all shadow-sm"
          >
          ...
          >
            ...
            <span className="font-semibold w-fit whitespace-nowrap">{t('AppPromo_Android')}</span>
          </button>
        </div>
      </div>
